...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr style="width:100%">
    <td bgcolor="#FFFFFF"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td><img style="border:none; width:100%" src="abc.jpg"/></td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="style24"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr valign="top">
              ...
              <td bgcolor="#126eb1" class="style25"><strong>Văn Khánh Thuận - ps03126 </strong><br>
                ĐỊA CHỈ: 391A Nam Kì Khởi Nghĩa, Quận 3, TP.HCM<br>
                Điện thoại: 01667510211<br>
                Nguồn: http://thietkewebdep.org/
                </td>
